...
export const protocols: ProtocolDefinition[] = [
  ...
  },
  {
    ...
    hint: "Paste sftp://user@host:22/folder or enter the SSH server details.",
    icon: LockKeyhole,
    defaultName: "My SFTP",
    defaultPort: "22",
  },
  {
    ...
    hint: "Paste ftp://host/folder or enter the FTP server details.",
    icon: Server,
    defaultName: "My FTP",
    defaultPort: "21",
  },
  {
    ...
    hint: "Paste //NAS/Media/Folder or enter the server and share separately.",
    icon: Network,
